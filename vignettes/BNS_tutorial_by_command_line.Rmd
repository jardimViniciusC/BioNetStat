...
## Dados de teste
Para realizar esse tutorial faça o download da tabela de [valores das variáveis](https://github.com/jardimViniciusC/BioNetStat/blob/master/inst/extdata/bnsData.csv) e dos [grupos de variáveis](https://github.com/jardimViniciusC/BioNetStat/blob/master/inst/extdata/c2.cp.v5.2.symbols.gmt).
...
```Rscript
varSets<-readSetFile(fileName = "~/path_to_file/c2.cp.v5.2.symbols.gmt")
```
